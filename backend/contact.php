            ...
            <tbody>
                ...
                ?>
                    <tr class='cent'>
                        ...
                        <td width="15%">
                            <input type="text" name="line[]" id="title" value="<?= $row['line']; ?>">
                        </td>
                        <td width="15%">
                            <input type="text" name="tel[]" id="title" value="<?= $row['tel']; ?>">
                        </td>
                        <td width="35%">
                            <input type="text" name="facebook[]" id="title" value="<?= $row['facebook']; ?>">
                        </td>
                        <td width="15%">
                            <input type="text" name="instagram[]" id="title" value="<?= $row['instagram']; ?>">
                        </td>
                        <td width="7%">
                            <input type="radio" name="sh" value="<?= $row['id']; ?>" <?= ($row['sh'] == 1) ? "checked" : ""; ?>>
                        </td>
