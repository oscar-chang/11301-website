        ...
        <table width="100%">
            <tbody>
                ...
                ?>
                    <tr class='cent'>
                        <td width="20%">
                            <input type="text" name="text[]" id="text" value="<?= $row['title']; ?>" style="width:98%">
                        </td>
                        <td width="20%">
                            <input type="text" name="text[]" id="text" value="<?= $row['en_title']; ?>" style="width:98%">
                        </td>
                        <td width="30%">
                            <input type="text" name="text[]" id="text" value="<?= $row['subtitle']; ?>" style="width:98%">
                        </td>
                        <!-- <td width="30%">
