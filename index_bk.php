...
<head>
	...
	<meta property="og:image" content="https://dragonkiss81.github.io/NTUballoon/img/slide/fb.png">
	</meta>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 wow fadeInRightBig" data-animation-delay="200">
					...
					<div class="sub-title lead2">Be happy for this moment. This moment is your life.</div>
					<p class="lead">
						我們是台大氣球社，一群熱愛氣球的大孩子！<br><br>
						造型氣球有一種神奇的魔力，當你用造型氣球編織出各種動物造型時，無論男女老幼都會露出歡樂的笑容！<br><br>
						本社有專業的氣球造型團隊和優良的社團導師，讓我們一起分享歡樂分享愛 : )
					</p>
				</div>
			</div>
		</div>
			...
			<div class="row tworow">
				<div class="col-sm-6  block wow bounceIn">
					<div class="row">
						...
						<div class="col-md-8 box-ct">
							<h3> 大型汽球場佈實戰 </h3>
							<p> 邁向頂尖！多樣又有成就感的大型場佈，與夥伴們一起揮灑創意。 </p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 block wow bounceIn">
					<div class="row">
						...
						<div class="col-md-8 box-ct">
							<h3>愛心慈善</h3>
							<p> 與慈善機構合作，和老人孩童一同玩樂、互相學習。我們相信氣球即分享，分享即喜悅。</p>
						</div>
					</div>
				</div>
			</div>
